...
public class UiHelper {
    ...
    private static final int MINUTE_MILLIS = 60 * UiHelper.SECOND_MILLIS;
    private static final int HOUR_MILLIS = 60 * UiHelper.MINUTE_MILLIS;
    /**
...
// Insert bold style
            builder.setSpan(UiHelper.sBoldSpan, startIndex - delta, endIndex
...
// behavior.
    ...
    public static boolean isHoneycombTablet(final Context context) {
        return UiHelper.hasHoneycomb() && UIUtils.isTablet(context);
    }
...
// Very crude at the moment
    ...
    public static void disableHardwareAcceleration(final View view) {
        if (UiHelper.isApiHighEnough(VERSION_CODES.HONEYCOMB)) {
