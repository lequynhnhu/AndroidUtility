...
public class IntentIntegrator {
    ...
    // blasd: protected for overriding
    protected static final String TAG = IntentIntegrator.class.getSimpleName();
    public static final String DEFAULT_TITLE = "Install Barcode Scanner?";
    public static final String DEFAULT_MESSAGE =
            "This application requires Barcode Scanner. Would you like to install it?";
    public static final String DEFAULT_YES = "Yes";
    public static final String DEFAULT_NO = "No";
    // blasd: removed final for overriding
    protected static final String BS_PACKAGE = "com.google.zxing.client.android";
    protected static final String BSPLUS_PACKAGE = "com.srowen.bs.android";
...
// What else supports this intent?
    ...
    protected String buttonYes;
    protected String buttonNo;
